...
public class PathFinder {
    ...
    private final WorldArea WILDERNESS_ABOVE_GROUND = new WorldArea(2944, 3523, 448, 448, 0);
    private final WorldArea WILDERNESS_UNDERGROUND = new WorldArea(2944, 9918, 320, 442, 0);
    ...
    public boolean isInWilderness(WorldPoint p) {
